...
import com.minh.springbatch.mapper.ProductRowMapper;
...
public class BatchConfiguration {
    ...
    @Bean
    public JdbcCursorItemReader jdbcItemReader() {
        return new JdbcCursorItemReaderBuilder<Product>()
                .dataSource(this.dataSource)
                .name("product")
                .sql("select prod_id, prod_name, prod_desc, unit, price from products")
    ...
    public JsonItemReader<Product> jsonItemReader() {
        return new JsonItemReaderBuilder<Product>()
                ...
                .resource(new FileSystemResource("input/product.json"))
