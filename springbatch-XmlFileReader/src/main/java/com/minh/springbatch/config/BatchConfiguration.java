...
public class BatchConfiguration {
    ...
    @StepScope
    @Bean
    public FlatFileItemReader flatFileFixedLengthItemReader (
    ) {

        FlatFileItemReader itemReader = new FlatFileItemReader();

        //step 1 let reader knows where is the file
        itemReader.setResource(new FileSystemResource("input/productfix.txt"));
    ...
    public FixedLengthTokenizer fixedLengthTokenizer() {
        ...
        tokenizer.setNames("productID", "productName", "ProductDesc", "price", "unit");
